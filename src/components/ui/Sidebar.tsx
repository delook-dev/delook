  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'flex gap-1 h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground',
            className,
          )}
          ref={ref}
          {...props}
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden border-r border-dashed text-sidebar-foreground md:block"
        data-state={state}
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex size-full flex-col overflow-auto bg-transparent group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          'bg-transperant md:w-[calc(100vw-25rem)] w-[calc(100vw-2rem)]',
